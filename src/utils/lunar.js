import {dt_T, XL, int2, pi2, pty_zty2, JD, J2000} from './eph0';
/**************************
寿星万年历中日对象的标准定义
假设日对象的数据结构为ob
·日的公历信息
    ...
    calcY: function (jd) {
        ...
        if (YY >= -721 && YY <= -104) {
            ...
            for (i = 0; i < 3; i++) {
                ...
                if (yy >= -479) (ns[i] = this.calc(1546083 - J2000 + int2(0.5 + (yy + 479) * 12.368422) * 29.5306, '朔')), (ns[i + 3] = '十三'), (ns[i + 6] = 2); //战国历,ly为-480.12.11
                if (yy >= -220) (ns[i] = this.calc(1640641 - J2000 + int2(0.866 + (yy + 220) * 12.369) * 29.5306, '朔')), (ns[i + 3] = '后九'), (ns[i + 6] = 11); //秦汉历,ly为-221.10.31
            }
            var nn, f1;
            for (i = 0; i < 14; i++) {
...
export {Lunar, nianLi2HTML, nianLiHTML, obb};
